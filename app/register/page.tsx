        ...
        <div className="w-full max-w-[380px]">
          ...
          <form onSubmit={handleSubmit} className="space-y-3.5">
            ...
            <div className="grid grid-cols-2 gap-3">
              <button type="button" className="flex items-center justify-center gap-2 rounded-xl border border-gray-200 bg-white py-2.5 text-sm font-medium shadow-sm transition hover:bg-gray-50">
              ...
              <button type="button" className="flex items-center justify-center gap-2 rounded-xl border border-gray-200 bg-white py-2.5 text-sm font-medium shadow-sm transition hover:bg-gray-50">
                <span className="text-sm font-bold text-green-600">N</span> {t.naver}
              </button>
            </div>
          </form>
        </div>
