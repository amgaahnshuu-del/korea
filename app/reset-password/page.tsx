...
function ResetPasswordForm() {
  ...
  if (!token) {
    return (
      <div className="text-center">
        <p className="mb-4 text-gray-500">Линк хүчингүй байна.</p>
  ...
  return done ? (
    <div className="rounded-2xl border border-green-200 bg-green-50 p-6 text-center">
      ...
      <h2 className="mb-2 text-lg font-bold text-gray-900">Нууц үг шинэчлэгдлээ</h2>
      <p className="text-sm text-gray-500">Нэвтрэх хуудас руу шилжиж байна...</p>
    </div>
  ) : (
    <>
      <h1 className="mb-1 text-2xl font-bold text-gray-900">Шинэ нууц үг тохируулах</h1>
      <p className="mb-7 text-sm text-gray-500">Хамгийн багадаа 6 тэмдэгт байна.</p>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          <label className="mb-1.5 block text-sm font-medium text-gray-700">Шинэ нууц үг</label>
          <div className="flex items-center gap-2 rounded-xl border border-gray-200 bg-white px-3.5 py-3 shadow-sm focus-within:border-blue-500 focus-within:ring-2 focus-within:ring-blue-100">
            <input
        ...
        <div>
          <label className="mb-1.5 block text-sm font-medium text-gray-700">Нууц үг давтах</label>
          <div className="flex items-center gap-2 rounded-xl border border-gray-200 bg-white px-3.5 py-3 shadow-sm focus-within:border-blue-500 focus-within:ring-2 focus-within:ring-blue-100">
            <input
              type="password"
              value={confirm}
